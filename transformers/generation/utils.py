    ...
    def sample(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            next_token_logits = outputs.logits[:, -1, :]
            # aaa = next_token_logits[:,eos_token_id].squeeze().cuda()
            # bbb = max(next_token_logits.squeeze()).cuda()
            # print('output_length:{};EOS_logits:{:.6};Max_logits:{:.6};End:{}'.format(len(input_ids[0,:]), aaa, bbb, aaa>=bbb))
